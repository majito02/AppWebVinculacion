...
const ReportsPage = () => {
  ...
  const obtenerciudades = () => {
    axios.get('http://localhost:3000/api/reportes/obtenerCiudades') //api obtener ciudades
  ...
  const descargarExcel = () => {
    axios
      .post('http://localhost:3000/api/reportes/descargarXLSX', {
  ...
  const descargarPDF = () => {
    ...
    axios
      .post(
        "http://localhost:3000/api/reportes/descargarPDF",
        {
          ciudad: selectedCiudad,
  ...
  const verPDF = () => {
    axios
      .post('http://localhost:3000/api/reportes/descargarPDF', {
        ciudad: selectedCiudad,
        barrio: selectedBarrio, titulo: selectedEmergencia, fechaInicio: selectedDateRange.startDate
        , fechaFin: selectedDateRange.endDate, horaInicio: selectedHoraInicio.$d, horaFin: selectedHoraFin.$d
      }, {
  ...
  const descargarCSV = () => {
    axios
      .post('http://localhost:3000/api/reportes/descargarCSV', {
        ciudad: selectedCiudad,
        barrio: selectedBarrio, titulo: selectedEmergencia, fechaInicio: selectedDateRange.startDate
        , fechaFin: selectedDateRange.endDate, horaInicio: selectedHoraInicio.$d, horaFin: selectedHoraFin.$d
      }, {
